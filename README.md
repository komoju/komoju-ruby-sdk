...
```shell
gem build komoju-ruby-sdk.gemspec
```

Then either install the gem locally:

```shell
gem install ./komoju-ruby-sdk-1.0.0.gem
```

(for development, run `gem install --dev ./komoju-ruby-sdk-1.0.0.gem` to install the development dependencies)
...
If the Ruby gem is hosted at a git repository: https://github.com/GIT_USER_ID/GIT_REPO_ID, then add the following in the Gemfile:
    ...
    gem 'komoju-ruby-sdk', :git => 'https://github.com/GIT_USER_ID/GIT_REPO_ID.git'
...
payment_request = Komoju::CreatePaymentRequestWithPaymentDetails.new(
  amount: 1000,
  currency: 'JPY',
  payment_details: {
    type: 'credit_card',
...
begin
  capture_request = Komoju::CapturePaymentRequest.new
  captured = payments_api.capture_payment('pay_xxx', capture_request)
...
session_request = Komoju::CreateSessionRequestWithPaymentMode.new(
  mode: 'payment',
  amount: 5000,
  currency: 'JPY',
...
## Documentation for Models
 ...
 - [Komoju::RefundPlatformDetails](docs/RefundPlatformDetails.md)
 - [Komoju::RefundRequest](docs/RefundRequest.md)
 - [Komoju::RefundRequestPlatformDetails](docs/RefundRequestPlatformDetails.md)
