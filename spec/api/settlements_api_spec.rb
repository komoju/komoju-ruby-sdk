...
describe 'SettlementsApi' do
  ...
  # unit tests for balance_transactions
  ...
  describe 'balance_transactions test' do
    it 'should work' do
  ...
  # unit tests for show_balance
  # Balance: Show
  # Given a currency, view the unsettled balance of the currently authenticated merchant.
  # @param currency 
  # @param [Hash] opts the optional parameters
  # @return [ShowBalance200Response]
  describe 'show_balance test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
