...
# Unit tests for Komoju::CreateCustomerRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Komoju::CreateCustomerRequest do
  #let(:instance) { Komoju::CreateCustomerRequest.new }

  describe 'test an instance of CreateCustomerRequest' do
    it 'should create an instance of CreateCustomerRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Komoju::CreateCustomerRequest)
    end
  end
