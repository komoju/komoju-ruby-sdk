...
# Unit tests for Komoju::PaymentData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Komoju::PaymentData do
  #let(:instance) { Komoju::PaymentData.new }

  describe 'test an instance of PaymentData' do
    it 'should create an instance of PaymentData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Komoju::PaymentData)
    end
  end
