...
# Unit tests for Komoju::CreateSubscriptionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Komoju::CreateSubscriptionRequest do
  let(:instance) { Komoju::CreateSubscriptionRequest.new }
  ...
  describe 'test an instance of CreateSubscriptionRequest' do
    it 'should create an instance of CreateSubscriptionRequest' do
      ...
      #expect(instance).to be_instance_of(Komoju::CreateSubscriptionRequest)
    end
  end
