...
# Unit tests for Komoju::UpdateCustomerRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Komoju::UpdateCustomerRequest do
  #let(:instance) { Komoju::UpdateCustomerRequest.new }

  describe 'test an instance of UpdateCustomerRequest' do
    it 'should create an instance of UpdateCustomerRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Komoju::UpdateCustomerRequest)
    end
  end
