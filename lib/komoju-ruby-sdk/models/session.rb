...
module Komoju
  class Session
    ...
    # ID of the customer associated with this session, if any.
    attr_accessor :customer_id

    # Secure token for client-side session access.
    attr_accessor :secure_token

    # Line items attached to this session.
    attr_accessor :line_items

    # ID of the merchant associated with this session.
    attr_accessor :merchant_id

    # Customer email address associated with this session.
    attr_accessor :email
