...
module Komoju
  # 
  class ResponsePaymentDetailsCreditCardTerminal < ApiModelBase
    # Payment method type.
    attr_accessor :type
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Komoju::ResponsePaymentDetailsCreditCardTerminal` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Komoju::ResponsePaymentDetailsCreditCardTerminal`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cardnet_status')
        self.cardnet_status = attributes[:'cardnet_status']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          year == o.year &&
          field55 == o.field55 &&
          cardnet_status == o.cardnet_status &&
