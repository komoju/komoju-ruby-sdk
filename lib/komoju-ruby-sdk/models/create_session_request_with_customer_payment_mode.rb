...
module Komoju
  ...
  class CreateSessionRequestWithCustomerPaymentMode < ApiModelBase
    ...
    def hash
      [mode, return_url, amount, currency, email, expires_in_seconds, external_customer_id, payment_types, default_locale, line_items, metadata, payment_data, customer_id].hash
    end
