...
module Komoju
  # 
  class ResponsePaymentDetailsWechatpay < ApiModelBase
    # Payment method type.
    attr_accessor :type
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Komoju::ResponsePaymentDetailsWechatpay` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Komoju::ResponsePaymentDetailsWechatpay`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'mweb_url')
        self.mweb_url = attributes[:'mweb_url']
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["wechatpay"])
      return false unless type_validator.valid?(@type)
      return false if @email.nil?
      trade_type_validator = EnumAttributeValidator.new('String', ["NATIVE", "MWEB"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["wechatpay"])
    ...
    def trade_type=(trade_type)
      validator = EnumAttributeValidator.new('String', ["NATIVE", "MWEB"])
