...
module Komoju
  # 
  class ResponsePaymentDetailsWebMoney < ApiModelBase
    # Payment method type.
    attr_accessor :type
    ...
    attr_accessor :short_amount

    attr_accessor :prepaid_cards
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Komoju::ResponsePaymentDetailsWebMoney` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Komoju::ResponsePaymentDetailsWebMoney`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'short_amount')
        self.short_amount = attributes[:'short_amount']
      end

      if attributes.key?(:'prepaid_cards')
        if (value = attributes[:'prepaid_cards']).is_a?(Array)
          self.prepaid_cards = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          type == o.type &&
          email == o.email &&
          short_amount == o.short_amount &&
          prepaid_cards == o.prepaid_cards &&
