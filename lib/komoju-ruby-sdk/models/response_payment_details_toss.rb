...
module Komoju
  # 
  class ResponsePaymentDetailsToss < ApiModelBase
    # Payment method type.
    attr_accessor :type
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Komoju::ResponsePaymentDetailsToss` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Komoju::ResponsePaymentDetailsToss`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'toss_pay_token')
        self.toss_pay_token = attributes[:'toss_pay_token']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          type == o.type &&
          email == o.email &&
          toss_pay_token == o.toss_pay_token &&
          qr_code == o.qr_code &&
