...
module Komoju
  # 
  class ResponsePaymentDetailsSofortbanking < ApiModelBase
    # Payment method type.
    attr_accessor :type
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Komoju::ResponsePaymentDetailsSofortbanking` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Komoju::ResponsePaymentDetailsSofortbanking`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'transaction_key')
        self.transaction_key = attributes[:'transaction_key']
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["sofortbanking"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["sofortbanking"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          type == o.type &&
          email == o.email &&
          transaction_key == o.transaction_key &&
