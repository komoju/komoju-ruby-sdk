...
module Komoju
  # 
  class CreatePaymentRequestWithCustomer
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Komoju::CreatePaymentRequestWithCustomer`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @customer.to_s.length < 25
        invalid_properties.push('invalid value for "customer", the character length must be great than or equal to 25.')
      end
    ...
    def customer=(customer)
      ...
      if customer.to_s.length < 25
        fail ArgumentError, 'invalid value for "customer", the character length must be great than or equal to 25.'
      end
