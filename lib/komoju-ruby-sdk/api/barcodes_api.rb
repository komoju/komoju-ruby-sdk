...
module Komoju
  class BarcodesApi
    ...
    # @param payment_id [String] Payment unique identifier
    # @param [Hash] opts the optional parameters
    # @return [Array<(ShowBarcode200Response, Integer, Hash)>] ShowBarcode200Response data, response status code and response headers
    def show_barcode_with_http_info(payment_id, opts = {})
      ...
      if @api_client.config.client_side_validation && payment_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "payment_id" when calling BarcodesApi.show_barcode, the character length must be greater than or equal to 25.'
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ShowBarcode200Response'
