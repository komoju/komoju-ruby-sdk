...
module Komoju
  class PlatformModelApi
    ...
    def create_file_with_http_info(merchant_id, create_file_request, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.create_file, the character length must be greater than or equal to 25.'
      end
    ...
    def create_merchant_balance_transfer_with_http_info(merchant_id, currency, create_merchant_balance_transfer_request, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.create_merchant_balance_transfer, the character length must be greater than or equal to 25.'
      end
    ...
    def edit_merchant_balance_settings_with_http_info(merchant_id, currency, edit_merchant_balance_settings_request, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.edit_merchant_balance_settings, the character length must be greater than or equal to 25.'
      end
    ...
    def list_live_application_payment_methods_with_http_info(merchant_id, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.list_live_application_payment_methods, the character length must be greater than or equal to 25.'
      end
    ...
    def list_submerchant_payments_with_http_info(merchant_id, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.list_submerchant_payments, the character length must be greater than or equal to 25.'
      end
    ...
    def list_submerchant_settlements_with_http_info(merchant_id, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.list_submerchant_settlements, the character length must be greater than or equal to 25.'
      end
    ...
    def merchant_balance_transactions_with_http_info(merchant_id, currency, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.merchant_balance_transactions, the character length must be greater than or equal to 25.'
      end
    ...
    def show_file_with_http_info(merchant_id, id, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.show_file, the character length must be greater than or equal to 25.'
      end
    ...
    def show_live_application_with_http_info(merchant_id, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.show_live_application, the character length must be greater than or equal to 25.'
      end
    ...
    def show_live_application_payment_method_with_http_info(merchant_id, payment_method, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.show_live_application_payment_method, the character length must be greater than or equal to 25.'
      end
    ...
    def show_merchant_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length < 25
        fail ArgumentError, 'invalid value for "id" when calling PlatformModelApi.show_merchant, the character length must be greater than or equal to 25.'
      end
    ...
    def show_merchant_balance_with_http_info(merchant_id, currency, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.show_merchant_balance, the character length must be greater than or equal to 25.'
      end
    ...
    def show_merchant_balance_settings_with_http_info(merchant_id, currency, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.show_merchant_balance_settings, the character length must be greater than or equal to 25.'
      end
    ...
    def show_merchant_balance_transaction_with_http_info(merchant_id, currency, transaction_uuid, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.show_merchant_balance_transaction, the character length must be greater than or equal to 25.'
      end
      ...
      if @api_client.config.client_side_validation && transaction_uuid.to_s.length < 25
        fail ArgumentError, 'invalid value for "transaction_uuid" when calling PlatformModelApi.show_merchant_balance_transaction, the character length must be greater than or equal to 25.'
      end
    ...
    def show_submerchant_settlement_with_http_info(merchant_id, id, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.show_submerchant_settlement, the character length must be greater than or equal to 25.'
      end
    ...
    def simulate_live_application_payment_method_status_with_http_info(merchant_id, payment_method, simulate_live_application_payment_method_status_request, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.simulate_live_application_payment_method_status, the character length must be greater than or equal to 25.'
      end
    ...
    def simulate_live_application_status_with_http_info(merchant_id, simulate_live_application_payment_method_status_request, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.simulate_live_application_status, the character length must be greater than or equal to 25.'
      end
    ...
    def submerchant_settlement_csv_with_http_info(merchant_id, id, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.submerchant_settlement_csv, the character length must be greater than or equal to 25.'
      end
    ...
    def submerchant_settlement_pdf_with_http_info(merchant_id, id, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.submerchant_settlement_pdf, the character length must be greater than or equal to 25.'
      end
    ...
    def submerchant_settlement_xls_with_http_info(merchant_id, id, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.submerchant_settlement_xls, the character length must be greater than or equal to 25.'
      end
    ...
    def update_live_application_with_http_info(merchant_id, live_application_request, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.update_live_application, the character length must be greater than or equal to 25.'
      end
    ...
    def update_live_application_payment_method_with_http_info(merchant_id, payment_method, update_payment_method_request, opts = {})
      ...
      if @api_client.config.client_side_validation && merchant_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "merchant_id" when calling PlatformModelApi.update_live_application_payment_method, the character length must be greater than or equal to 25.'
      end
    ...
    def update_merchant_with_http_info(id, update_merchant_request, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length < 25
        fail ArgumentError, 'invalid value for "id" when calling PlatformModelApi.update_merchant, the character length must be greater than or equal to 25.'
      end
