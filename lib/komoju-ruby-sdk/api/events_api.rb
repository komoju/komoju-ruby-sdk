  ...
  class EventsApi
    ...
    def show_event_with_http_info(id, opts = {})
      ...
      if @api_client.config.client_side_validation && id.to_s.length > 25
        fail ArgumentError, 'invalid value for "id" when calling EventsApi.show_event, the character length must be smaller than or equal to 25.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 25
        fail ArgumentError, 'invalid value for "id" when calling EventsApi.show_event, the character length must be greater than or equal to 25.'
      end
