...
module Komoju
  class PaymentsApi
    ...
    def list_payment_methods(opts = {})
      list_payment_methods_with_http_info(opts)
      nil
    end
    ...
    # @param id [String] A unique identifier for the payment.
    # @param refund_request_request [RefundRequestRequest] 
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def refund_request(id, refund_request_request, opts = {})
      refund_request_with_http_info(id, refund_request_request, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def refund_request_with_http_info(id, refund_request_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: PaymentsApi.refund_request ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling PaymentsApi.refund_request"
      end
      # verify the required parameter 'refund_request_request' is set
      if @api_client.config.client_side_validation && refund_request_request.nil?
        fail ArgumentError, "Missing the required parameter 'refund_request_request' when calling PaymentsApi.refund_request"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(refund_request_request)
      ...
      new_options = opts.merge(
        :operation => :"PaymentsApi.refund_request",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: PaymentsApi#refund_request\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
