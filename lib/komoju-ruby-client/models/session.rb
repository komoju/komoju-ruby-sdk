...
module Komoju
  class Session < ApiModelBase
    ...
    def hash
      [id, resource, mode, amount, currency, session_url, return_url, default_locale, payment_methods, created_at, cancelled_at, completed_at, status, expired, metadata, payment, payment_data].hash
    end
