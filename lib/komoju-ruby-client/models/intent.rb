...
module Komoju
  class Intent
    ...
    def self.all_vars
      @all_vars ||= [ONE_TIME, CARD_ON_FILE, SUBSCRIPTION, INSTALLMENT, NULL].freeze
    end
    ...
    def build_from_hash(value)
      return value if Intent.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #Intent"
    end
  end
end
