...
module Komoju
  class PlatformModelApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Locale] :locale 
    # @return [PaymentMethodApplicationWithSubmittedFields]
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [Locale] :locale 
    # @return [Array<(PaymentMethodApplicationWithSubmittedFields, Integer, Hash)>] PaymentMethodApplicationWithSubmittedFields data, response status code and response headers
    def show_live_application_payment_method_with_http_info(merchant_id, payment_method, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaymentMethodApplicationWithSubmittedFields'
    ...
    # @param [Hash] opts the optional parameters
    # @return [PaymentMethodApplication]
    ...
    # @param update_payment_method_request [UpdatePaymentMethodRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(PaymentMethodApplication, Integer, Hash)>] PaymentMethodApplication data, response status code and response headers
    def update_live_application_payment_method_with_http_info(merchant_id, payment_method, update_payment_method_request, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'PaymentMethodApplication'
