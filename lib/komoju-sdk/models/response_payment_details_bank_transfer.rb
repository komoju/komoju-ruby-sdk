...
module Komoju
  # 
  class ResponsePaymentDetailsBankTransfer < ApiModelBase
    # Payment method type.
    attr_accessor :type
    ...
    attr_accessor :account_branch_name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Komoju::ResponsePaymentDetailsBankTransfer` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Komoju::ResponsePaymentDetailsBankTransfer`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'account_branch_name')
        self.account_branch_name = attributes[:'account_branch_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          account_branch_name == o.account_branch_name &&
