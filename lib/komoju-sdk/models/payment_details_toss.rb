...
module Komoju
  ...
  class PaymentDetailsToss
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Komoju::PaymentDetailsToss`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @birthday.to_s.length < 6
        invalid_properties.push('invalid value for "birthday", the character length must be great than or equal to 6.')
      end
    ...
    def birthday=(birthday)
      ...
      if birthday.to_s.length < 6
        fail ArgumentError, 'invalid value for "birthday", the character length must be great than or equal to 6.'
      end
