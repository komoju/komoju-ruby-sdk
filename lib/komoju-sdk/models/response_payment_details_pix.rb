...
module Komoju
  # 
  class ResponsePaymentDetailsPix < ApiModelBase
    # Payment method type.
    attr_accessor :type
    ...
    attr_accessor :pix_payment_code
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Komoju::ResponsePaymentDetailsPix` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Komoju::ResponsePaymentDetailsPix`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'pix_payment_code')
        self.pix_payment_code = attributes[:'pix_payment_code']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          pix_payment_code == o.pix_payment_code &&
