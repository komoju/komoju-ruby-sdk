...
module Komoju
  class SecureToken < ApiModelBase
    ...
    attr_accessor :three_d_secure_account
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'three_d_secure_account')
        self.three_d_secure_account = attributes[:'three_d_secure_account']
      end
    ...
    def valid?
      ...
      verification_status_validator = EnumAttributeValidator.new('String', ["OK", "NEEDS_VERIFY", "ERRORED", "SKIPPED", "CREATED", "EXPIRED"])
    ...
    def verification_status=(verification_status)
      validator = EnumAttributeValidator.new('String', ["OK", "NEEDS_VERIFY", "ERRORED", "SKIPPED", "CREATED", "EXPIRED"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          three_d_secure_account == o.three_d_secure_account &&
    ...
    def hash
      [id, created_at, verification_status, authentication_url, three_d_secure_account, three_ds_auth_result].hash
    end
