...
module Komoju
  class RefundRequest
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Komoju::RefundRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @payment.to_s.length < 25
        invalid_properties.push('invalid value for "payment", the character length must be great than or equal to 25.')
      end
      ...
      if @branch_number.to_s.length < 3
        invalid_properties.push('invalid value for "branch_number", the character length must be great than or equal to 3.')
      end
    ...
    def payment=(payment)
      ...
      if payment.to_s.length < 25
        fail ArgumentError, 'invalid value for "payment", the character length must be great than or equal to 25.'
      end
    ...
    def branch_number=(branch_number)
      ...
      if branch_number.to_s.length < 3
        fail ArgumentError, 'invalid value for "branch_number", the character length must be great than or equal to 3.'
      end
