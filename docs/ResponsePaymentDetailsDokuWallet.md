...
| **redirect_url** | **String** | URL to redirect the customer to for completing the DOKU Wallet payment. | [optional] |
| **transaction_id** | **String** | Transaction identifier returned by DOKU. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsDokuWallet.new(
  type: null,
