...
| **provider** | **String** |  |  |
| **redirect_url** | **String** | URL to redirect the customer to for completing the mobile carrier payment. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsMobileJapan.new(
  type: null,
