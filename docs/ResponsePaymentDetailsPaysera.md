...
| **redirect_url** | **String** | URL to redirect the customer to for completing the Paysera payment. | [optional] |
| **transaction_id** | **String** | Transaction identifier returned by Paysera. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsPaysera.new(
  type: null,
