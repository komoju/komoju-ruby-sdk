...
| **charge_key** | **String** | Charge key returned by Rakuten Pay. | [optional] |
| **redirect_url** | **String** | URL to redirect the customer to for completing the Rakuten Pay payment. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsRakutenpay.new(
  type: null,
