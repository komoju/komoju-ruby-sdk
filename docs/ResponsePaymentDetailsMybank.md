...
| **redirect_url** | **String** | URL to redirect the customer to for completing the MyBank payment. | [optional] |
| **transaction_id** | **String** | Transaction identifier returned by MyBank. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsMybank.new(
  type: null,
