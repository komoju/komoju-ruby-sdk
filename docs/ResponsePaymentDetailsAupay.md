...
| **transaction_id** | **String** | Transaction identifier returned by au PAY. | [optional] |
| **redirect_url** | **String** | URL to redirect the customer to for completing the au PAY payment. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsAupay.new(
  type: null,
