...
| **redirect** | **Boolean** | Whether the payment uses a redirect flow. | [optional] |
...
| **digital_content_only** | **Boolean** | Whether this payment is for digital content only. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsNaverpay.new(
  type: null,
