...
| **hashed_gateway** | **String** | Hashed identifier of the payment gateway processing this method. |  |
| **amount** | **Integer** | Amount greater than or equal to 0, in the lowest denomination of the currency (e.g. cents for USD). |  |
| **currency** | [**Currency**](Currency.md) |  |  |
| **exchange_rate** | **Float** | Exchange rate applied when this payment method&#39;s currency differs from the session currency. |  |
