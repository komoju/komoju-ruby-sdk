...
| **cpf** | **String** | Customer&#39;s CPF number |  |
| **customer_ip** | **String** | Specify customer&#39;s IPv4 or IPv6-formatted IP address of the customer. |  |
...
instance = Komoju::PaymentDetailsPix.new(
  type: null,
  name: John Doe,
