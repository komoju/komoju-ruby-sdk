...
| **redirect_url** | **String** | URL to redirect the customer to for completing the Narvesen payment. | [optional] |
| **transaction_id** | **String** | Transaction identifier returned by Narvesen. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsNarvesen.new(
  type: null,
