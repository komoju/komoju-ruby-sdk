...
| **transacion_key** | **String** | Transaction key returned by iDEAL. | [optional] |
| **redirect_url** | **String** | URL to redirect the customer to for completing the iDEAL payment. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsIdeal.new(
  type: null,
