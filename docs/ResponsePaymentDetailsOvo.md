...
| **redirect_url** | **String** | URL to redirect the customer to for completing the OVO payment. | [optional] |
| **transaction_id** | **String** | Transaction identifier returned by OVO. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsOvo.new(
  type: null,
