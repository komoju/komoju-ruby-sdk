...
| **redirect_url** | **String** | URL to redirect the customer to for completing the Przelewy24 payment. | [optional] |
| **transaction_id** | **String** | Transaction identifier returned by Przelewy24. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsPrzelewy24.new(
  type: null,
