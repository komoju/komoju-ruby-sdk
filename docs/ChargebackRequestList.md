...
| ---- | ---- | ----------- | ----- |
| **resource** | **String** | Resource type name, always \&quot;list\&quot;. |  |
| **data** | [**Array&lt;ChargebackRequestListItem&gt;**](ChargebackRequestListItem.md) | Array of chargeback request objects for this page. |  |
...
instance = Komoju::ChargebackRequestList.new(
  resource: null,
  data: null,
  start_time: null,
  end_time: null,
