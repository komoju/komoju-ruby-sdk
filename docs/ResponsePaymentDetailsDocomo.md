...
| **redirect_url** | **String** | URL to redirect the customer to for completing the docomo payment. | [optional] |
| **provider_order_number** | **String** | Order number provided by carrier. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsDocomo.new(
  type: null,
  email: example@komoju.com,
  redirect_url: null,
  provider_order_number: 612345678910,
