...
| **redirect_url** | **String** | URL to redirect the customer to for completing the UnionPay payment. | [optional] |
| **transaction_id** | **String** | Transaction identifier returned by UnionPay. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsUnionpay.new(
  type: null,
