...
| **secure_token** | [**SecureToken**](SecureToken.md) |  | [optional] |
| **line_items** | [**Array&lt;LineItem&gt;**](LineItem.md) | Line items for this session. Only present when line items were provided on create. | [optional] |
