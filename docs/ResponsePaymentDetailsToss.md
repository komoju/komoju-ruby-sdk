...
| **toss_pay_token** | **String** | Token for the Toss Pay payment flow. | [optional] |
| **qr_code** | **String** | QR code data for the Toss payment. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsToss.new(
  type: null,
