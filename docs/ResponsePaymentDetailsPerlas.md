...
| **redirect_url** | **String** | URL to redirect the customer to for completing the Perlas payment. | [optional] |
| **transaction_id** | **String** | Transaction identifier returned by Perlas. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsPerlas.new(
  type: null,
