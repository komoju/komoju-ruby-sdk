...
| **transaction_key** | **String** | Transaction key returned by the SEPA transfer provider. | [optional] |
| **redirect_url** | **String** | URL to redirect the customer to for completing the SEPA transfer. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsSepaTransfer.new(
  type: null,
