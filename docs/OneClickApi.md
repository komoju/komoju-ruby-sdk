...
> <DeleteExternalCustomer204Response> delete_external_customer(id)
...
> <Array(<DeleteExternalCustomer204Response>, Integer, Hash)> delete_external_customer_with_http_info(id)
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <DeleteExternalCustomer204Response>
rescue Komoju::ApiError => e
...
[**DeleteExternalCustomer204Response**](DeleteExternalCustomer204Response.md)
