...
| **transaction_key** | **String** | Transaction key returned by giropay. | [optional] |
| **redirect_url** | **String** | URL to redirect the customer to for completing the giropay payment. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsGiropay.new(
  type: null,
