...
| **redirect_url** | **String** | URL to redirect the customer to for completing the Paysafecard payment. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsPaysafeCard.new(
  type: null,
