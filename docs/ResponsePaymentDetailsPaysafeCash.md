...
| **redirect_url** | **String** | URL to redirect the customer to for completing the Paysafecash payment. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsPaysafeCash.new(
  type: null,
