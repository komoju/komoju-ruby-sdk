...
| **short_amount** | **Integer** | Amount the payment is short by if insufficient funds were provided. | [optional] |
| **prepaid_cards** | [**Array&lt;PrepaidCards&gt;**](PrepaidCards.md) | List of prepaid cards used in this transaction. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsWebMoney.new(
  type: null,
