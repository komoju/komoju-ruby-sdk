...
| **redirect_url** | **String** | URL to redirect the customer to for completing the POLi payment. | [optional] |
| **transaction_id** | **String** | Transaction identifier returned by POLi. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsPoli.new(
  type: null,
