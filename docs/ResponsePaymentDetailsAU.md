...
| **redirect_url** | **String** | URL to redirect the customer to for completing the au payment. | [optional] |
| **transaction_id** | **String** | Transaction identifier returned by au. | [optional] |
| **pay_info_no** | **String** | Payment information number for this au transaction. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsAU.new(
  type: null,
