...
| **redirect_url** | **String** | URL to redirect the customer to for completing the eps payment. | [optional] |
| **transaction_id** | **String** | Transaction identifier returned by eps. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsEps.new(
  type: null,
