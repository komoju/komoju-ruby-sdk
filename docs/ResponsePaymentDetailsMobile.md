...
| **provider** | **String** | Mobile carrier or payment provider for this payment. | [optional] |
| **redirect_url** | **String** | URL to redirect the customer to for completing the mobile payment. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsMobile.new(
  type: null,
