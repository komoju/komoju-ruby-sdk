...
| **redirect_url** | **String** | URL to redirect the customer to for completing the BLIK payment. | [optional] |
| **transaction_id** | **String** | Transaction identifier returned by BLIK. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsBlik.new(
  type: null,
