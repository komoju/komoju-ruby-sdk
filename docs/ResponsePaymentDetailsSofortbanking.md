...
| **transaction_key** | **String** | Transaction key returned by Sofort. | [optional] |
| **redirect_url** | **String** | URL to redirect the customer to for completing the Sofort payment. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsSofortbanking.new(
  type: null,
