...
> <ShowBarcodeResponse> show_barcode(payment_id)
...
> <Array(<ShowBarcodeResponse>, Integer, Hash)> show_barcode_with_http_info(payment_id)
...
[**ShowBarcodeResponse**](ShowBarcodeResponse.md)
