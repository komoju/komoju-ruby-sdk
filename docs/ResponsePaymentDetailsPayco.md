...
| **order_sheet_url** | **String** | URL to the PAYCO order sheet for the customer. | [optional] |
| **redirect_url** | **String** | URL to redirect the customer to for completing the PAYCO payment. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsPayco.new(
  type: null,
