...
| **confirmation_code** | **String** | Confirmation code for the konbini payment slip. | [optional] |
| **receipt** | **String** | Receipt number for the konbini payment. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsKonbini.new(
  type: null,
  store: null,
