# Komoju::ResponsePaymentDetailsGrabpayotp
...
| **redirect_url** | **String** | URL to redirect the customer to for completing the GrabPay payment. | [optional] |
| **transaction_id** | **String** | Transaction identifier returned by GrabPay. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsGrabpayotp.new(
  type: null,
