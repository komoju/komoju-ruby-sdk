...
| **redirect_url** | **String** | URL to redirect the customer to for completing the Dragonpay payment. | [optional] |
| **transaction_id** | **String** | Transaction identifier returned by Dragonpay. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsDragonpay.new(
  type: null,
