...
| **redirect_url** | **String** | URL to redirect the customer to for completing the PayPost payment. | [optional] |
| **transaction_id** | **String** | Transaction identifier returned by PayPost. | [optional] |
