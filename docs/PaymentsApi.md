...
- [**CapturePaymentRequest**](CapturePaymentRequest.md) — used by `capture_payment`
- [**CreatePaymentRequest**](CreatePaymentRequest.md) — used by `create_payment`
- [**CreateRefundRequestRequest**](CreateRefundRequestRequest.md) — used by `create_refund_request`
- [**FinalizePaymentRequest**](FinalizePaymentRequest.md) — used by `finalize_payment`
- [**RefundPaymentRequest**](RefundPaymentRequest.md) — used by `refund_payment`
- [**UpdatePaymentRequest**](UpdatePaymentRequest.md) — used by `update_payment`
