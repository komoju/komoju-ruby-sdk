...
| ---- | ---- | ----------- | ----- |
| **resource** | **String** | Resource type name, always \&quot;payment_list\&quot;. |  |
| **data** | [**Array&lt;Payment&gt;**](Payment.md) | Array of payment objects for this page. |  |
...
instance = Komoju::PaymentList.new(
  resource: null,
  data: null,
  start_time: null,
  end_time: null,
