...
| **transaction_id** | **String** | Transaction identifier returned by Alipay. | [optional] |
| **redirect_url** | **String** | URL to redirect the customer to for completing the Alipay payment. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsAlipay.new(
  type: null,
