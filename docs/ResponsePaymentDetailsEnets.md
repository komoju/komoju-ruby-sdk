...
| **redirect_url** | **String** | URL to redirect the customer to for completing the eNETS payment. | [optional] |
| **transaction_id** | **String** | Transaction identifier returned by eNETS. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsEnets.new(
  type: null,
