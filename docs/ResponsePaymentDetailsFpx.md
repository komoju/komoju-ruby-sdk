...
| **redirect_url** | **String** | URL to redirect the customer to for completing the FPX payment. | [optional] |
| **transaction_id** | **String** | Transaction identifier returned by FPX. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsFpx.new(
  type: null,
