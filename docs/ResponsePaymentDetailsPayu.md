...
| **redirect_url** | **String** | URL to redirect the customer to for completing the PayU payment. | [optional] |
| **transaction_id** | **String** | Transaction identifier returned by PayU. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsPayu.new(
  type: null,
