...
| **redirect_url** | **String** | URL to redirect the customer to for completing the Multibanco payment. | [optional] |
| **transaction_id** | **String** | Transaction identifier returned by Multibanco. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsMultibanco.new(
  type: null,
