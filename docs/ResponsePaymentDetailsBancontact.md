...
| **transaction_key** | **String** | Transaction key returned by Bancontact. | [optional] |
| **redirect_url** | **String** | URL to redirect the customer to for completing the Bancontact payment. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsBancontact.new(
  type: null,
