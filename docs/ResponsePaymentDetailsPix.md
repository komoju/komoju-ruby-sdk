...
| **redirect_url** | **String** | URL to redirect the customer to for completing the PIX payment. | [optional] |
| **transaction_code** | **String** | PIX transaction code. | [optional] |
| **qr_code_url** | **String** | URL to the QR code image for the PIX payment. | [optional] |
| **pix_payment_code** | **String** | PIX payment code that the customer can use to complete the payment. | [optional] |
...
instance = Komoju::ResponsePaymentDetailsPix.new(
  type: null,
